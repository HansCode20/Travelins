  ...
  <div className="aspect-w-4 aspect-h-3">
    {data?.imageUrls ? 
      data.imageUrls.map((img, index) => (
        <img key={index} src={img} alt={data?.title} className="object-cover w-full h-full" />
      )) :
      <img src={data?.imageUrl} alt="Sunset in the mountains" className="object-cover w-full h-full" />
    }
  </div>
  <div className="p-4">
